...
class GameBloc extends Bloc<GameEvent, GameState> {
  ...
  Stream<GameState> mapEventToState(
    ...
    "0" : {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[0]},
    "1" : {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[1]},
    "2" : {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[2]},
    "3" : {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[3]},
    "4" : {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[4]},
    "5" : {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[5]},
    "6" : {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[6]},
    "7" : {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[7]},
    "8" : {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[8]},
    "9":  {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[9]}, 
    "10": {"stay_flipped_open": true, "do_animation": true, "image": shuffled_image_list[10]},
